...
<head lang="pt-BR">
	...
	<link rel="stylesheet" type="text/css" href="css/autores-style.css">
	<link rel="shortcut icon" type="image/png" href="img/icontitle.png">
	<title>CCNews | Autores</title>
</head>
<body>
	<header>
	...
	<div id="container-main">
		<section>
			...
			<div class="box-autor-right">
				<img class="float-right img-rounded" src="http://placehold.it/150x150" alt="autor">
				<h2>Nome do Autor</h2>
				<div class="aricle clear-left">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
					quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
					consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
